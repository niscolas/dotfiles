...
beautiful.init("/home/niscolas/.config/awesome/theme.lua")
...
awful.rules.rules = {
    ...
    { rule = { class = "Hidamari" }, properties = { tags = root.tags() } },
}
-- }}}
...
awful.spawn.with_shell("killall hidamari-server")
awful.spawn("hidamari --background")
